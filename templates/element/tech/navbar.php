    ...
    <ul class="navbar-nav">
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
          ...
          <a href="<?= $this->Url->build(['prefix' => 'Tech', 'controller' => 'ServiceForms', 'action' => 'index']) ?>" class="dropdown-item">
            <i class="fas fa-tools mr-2"></i>CHANGE PASSWORD
          </a>
          <div class="dropdown-divider"></div>
          <a href="<?= $this->Url->build(['prefix' => 'Tech', 'controller' => 'Users', 'action' => 'edit', $this->request->getAttribute('identity')->getIdentifier()]) ?>" class="dropdown-item">
            <i class="fas fa-users mr-2"></i>EDIT PROFILE
          </a>
          <div class="dropdown-divider"></div>
          <a href="<?= $this->Url->build(['prefix' => 'Tech', 'controller' => 'Users', 'action' => 'view', $this->request->getAttribute('identity')->getIdentifier()]) ?>" class="dropdown-item">
      ...
      <li class="nav-item d-none d-sm-inline-block">
          <a href="<?= $this->Url->build(['prefix' => 'Tech', 'controller' => 'Items', 'action' => 'index']) ?>" class="nav-link"><strong>
              INVENTORY</strong></a>
      </li>
      <li class="nav-item d-none d-sm-inline-block">
