                ...
                <tr>
                  ...
                  <td>
                      <?php if ($serviceForm->photo): ?>
                          <img src="/nc-inventory-system/<?= h($serviceForm->photo) ?>" alt="Photo" style="max-width: 200px; max-height: 200px;">
                      <?php else: ?>
                          -
                      <?php endif; ?>
                  </td>
              </tr>
                <tr><th><?= __('Description') ?></th><td><?= nl2br(h($serviceForm->description)) ?></td></tr>
